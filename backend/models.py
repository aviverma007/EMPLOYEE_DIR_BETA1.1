...
class MeetingRoom(BaseModel):
    ...
    current_booking: Optional[MeetingRoomBooking] = Field(None, description="Current active booking")
    bookings: List[MeetingRoomBooking] = Field(default_factory=list, description="All bookings for this room")
