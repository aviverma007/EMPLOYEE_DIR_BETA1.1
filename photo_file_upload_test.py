...
EXTERNAL_URL = "https://cd392ac5-1e4f-4dba-b702-6f44718c5281.preview.emergentagent.com/api"
        ...
        if upload_response.status_code == 200:
            ...
            if profile_image_url and '/api/uploads/images/' in profile_image_url:
                ...
                if profile_image_url.startswith('/api/'):
                    full_image_url = f"https://cd392ac5-1e4f-4dba-b702-6f44718c5281.preview.emergentagent.com{profile_image_url}"
                else:
