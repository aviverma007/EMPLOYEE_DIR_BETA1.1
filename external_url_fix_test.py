...
EXTERNAL_URL = "https://profile-gallery-4.preview.emergentagent.com/api"
    ...
    def test_4_photo_accessibility_via_external_url(self):
        ...
        try:
            ...
            if profile_image_url.startswith('/api/'):
                full_image_url = f"https://profile-gallery-4.preview.emergentagent.com{profile_image_url}"
            else:
